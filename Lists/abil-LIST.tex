...
\NEW{Abil}{\aShark}{
  \s\MYname	{SHARK ATTACK}
  \s\MYtext	{Use only on a target with a red headband that you just knocked out. They are knocked out for 10 minutes instead of 5.}
  \s\MYeffect	{I knock you out fo 10 minutes instead of 5.}
}
