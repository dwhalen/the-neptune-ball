...
\NEW{Abil}{\aFirstAid}{
  ...
  \s\MYeffect	{You are no longer wounded or bloody. Take off you red headband immediately nd wake up after 2 minutes.} % TODO: add alpha score to magicians.
}
...
\NEW{Abil}{\aSummonGuards}{
  ...
  \s\MYeffect	{Guards appear and roughly grab your arms. They assist me in escorting you to the dungeon. You are restrained as we walk.} % TODO: add alpha score to magicians.
}
...
\NEW{Abil}{\aRunAway}{
  ...
  \s\MYeffect	{Your ability has no effect.} % TODO: add alpha score to magicians.
}
...
\NEW{Abil}{\aUnnoticed}{
  ...
  \s\MYeffect	{You don't see me.} % TODO: add alpha score to magicians.
}
...
\NEW{Abil}{\aTeleport}{
  ...
  \s\MYeffect	{I vanish.} % TODO: add alpha score to magicians.
}
...
\NEW{Abil}{\aRemoveDisguise}{
  ...
  \s\MYeffect	{I tear off my mask, alter my posture, and suddenly look totally different.} % TODO: add alpha score to magicians.
}
...
\NEW{Abil}{\aMonsterTransformation}{
  ...
  \s\MYeffect	{I become invulnerable, break any restrains, and turn into a giant monster. Rawr!} % TODO: add alpha score to magicians.
}
