...
\NEW{MemPage}{\mMantaB}{
  ...
  \s\MYtext	{\cManta{} has a very interesting history, with many\ldots{} suspicious\ldots{} gaps. Whatever \cManta{\they} is up to, you might want to keep an eye on \cManta{\them}. \cManta{\They} is not your suspect though.}
}
...
\NEW{MemPage}{\mBodyguardB}{
  ...
  \s\MYtext	{As a \pPacifica{}n, your information on \cBodyguard{} is limited, but \cBodyguard{} appears to be \cPrince{}'s personal guard. Records do indicate that \cBodyguard{} wants a child very badly, but \cBodyguard{\they} is not your suspect.}
}
