...
\NEW{MemFold}{\mWPacket}{
  \s\MYname	{W packet}
  \s\MYtext	{\cSpy{} is clearly researching the history of the war -- your past. \cSpy{\They} might help you prove that \cExExKing{} kidnapped and raped your \cMother{\parent}, leading to your conception. Mentioning \cMother{} should be enough to set \cSpy{} on th right track without giving too much away.}
}
