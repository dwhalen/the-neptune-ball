...
\NEW{PC}{\cKing}{
  ...
  \s\MYabils	{\aFirstAid{} \aSummonGuards{} \aMerengue{}}
  \s\MYitems	{\iTrident{}} 
  \s\MYwhites	{\wTreaty{}}
  \s\MYmems {\mDepression{}}
...
\NEW{PC}{\cGeneral}{
   ...
   \s\MYsex      {\male}
   \s\MYnumber	{598}
   \s\MYdesc     {A stern merman wearing a millitary uniform}
	 \s\MYplayer	{Wael Salloum}
...
\NEW{PC}{\cSlave}{ %% Eric and Ariel know him by the name Aldric (he is in disguise right now)
   ...
   \s\MYsex      {\male}
   \s\MYnumber	{649}
   \s\MYdesc     {An elderly merman with a knowing glint in his eye.}   
...
\NEW{PC}{\cPriest}{
   \s\MYname	{Aretis Aquilino}
   \s\MYfile	{Urchin.tex}
   \s\MYsex      {\female}
   \s\MYnumber	{312}
   \s\MYdesc     {A priestess in the Church of the Tides}
	 \s\MYplayer	{Maia Peirce}
  
  \s\MYblues	{\bExplorer{} \bAtlantican{}}
  \s\MYgreens	{\gDecking{} \nGazaStrip{}}
  \s\MYabils	{\aReligiousRites{}}
  \s\MYitems	{}
  \s\MYwhites	{}
...
\NEW{PC}{\cPrincess}{ 
  ...
  \s\MYgreens	{\gDecking{} \gTreaty{} \gDance{}}
  \s\MYabils	{\aSummonGuards{} \aMerengue{}}
  \s\MYitems	{}
  \s\MYwhites	{}
...
\NEW{PC}{\cAriel}{
   ...
   \s\MYsex      {\female}
   \s\MYnumber	{386}
   \s\MYdesc     {A young human with flaming red hair.}   
	 \s\MYplayer	{Jane Andreasen}
  
  \s\MYblues	{\bAtlantican{} \bHuman{}}
  \s\MYgreens	{\gDecking{}}
  \s\MYabils	{\aFirstAid{} \aSwing{}}
  \s\MYitems	{\iArielBracelet{}}
  \s\MYwhites	{}
...
\NEW{PC}{\cWillow}{
   ...
   \s\MYsex      {\male}
   \s\MYnumber	{143}
   \s\MYdesc     {An 11 year old human kid with curly red hair.}
	 \s\MYplayer	{Daniel Kane}
  
  \s\MYblues	{\bHuman{}}
  \s\MYgreens	{\gDecking{}}
  \s\MYabils	{\aInspiration{} \aRunAway{} \aUnnoticed{} \aSwing{}}
  \s\MYitems	{}
  \s\MYwhites	{}
  \s\MYmems {\mExplosion{}}
...
\NEW{PC}{\cManta}{
  ...
  \s\MYmems {\mREnvelope{} \mQPacketManta{}}
...
\NEW{PC}{\cDiplomat}{
   ...
   \s\MYdesc     {A young mermaid with a friendly smile.}   
	 \s\MYplayer	{Kasiemobi Udo-okoye}
...
\NEW{PC}{\cBodyguard}{
   ...
   \s\MYsex      {\female}
   \s\MYnumber	{397}
   \s\MYdesc     {A powerful merwoman. Not one to tangle with lightly.}   
	 \s\MYplayer	{Caroline Suen}
...
\NEW{PC}{\cPrince}{
   ...
   \s\MYsex      {\male}
   \s\MYnumber	{271}
   \s\MYdesc     {A handsome merman with a regal air.}   
...
\NEW{PC}{\cSpy}{
   ...
   \s\MYsex      {\male}
   \s\MYnumber	{347}
   \s\MYdesc     {A young merman with a slightly distracted look.}   
	 \s\MYplayer	{David Lo}
...
\NEW{PC}{\cPlant}{
   ...
   \s\MYsex      {\female}
     \s\MYnumber	{481}
  \s\MYdesc     {A middle age mermaid with a rugged and wild look.}   
