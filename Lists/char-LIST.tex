...
\pronoun{\mer}		{boy}{maid}{child} %%teenager
...
\NEW{Name}{\cEric}{ %%In case we need tochange the name later (also easy to add  dif name to pacificans)
	\s\MYname   {Eric}
	\s\MYsex			{\male}
}
