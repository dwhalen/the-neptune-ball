...
\NEW{PC}{\cKing}{
   ...
   \s\MYsex      {\male}
   \s\MYnumber	{726}
    \s\MYdesc   {The venerable ruler of Atlantis.}
 
  \s\MYblues	{\bAtlantian{}}
  \s\MYgreens	{} %%\nBrainDamage{}
  \s\MYabils	{}
  \s\MYitems	{\iTriton{}}
...
\NEW{PC}{\cAriel}{
   ...
   \s\MYsex      {\female}
   \s\MYnumber	{224}
    \s\MYdesc   {A young mermaid with flaming red hair.}
