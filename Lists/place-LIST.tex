...
\NEW{Place}{\pLibrary}{ %%Royal archives; Treasury  = Museum
   \s\MYname	{Room -002}
   \s\MYsigns	{\sMuseum{} \sMuseum{} \sMuseumItems{} \sArtifactZero{} \sArtifactZeroRestored{} \sArtifactOne{} \sArtifactTwo{} \sArtifactTwoBroken{} \sArtifactThree{} \sArtifactThreeBroken{} \sArtifactFour{} \sArtifactFourOpened{} \sBlackboard{} \sBookshelf{} \sBookshelfRapsheet{} \sBookshelfBook{} \sInheritance{} \sLineageOne{} \sLineageTwo{} \sDotOne{}}
...
\NEW{Place}{\pDungeons}{
  \s\MYname	{Hall off of -002}
	\s\MYsigns	{\sBarnacles{} \sDungeons{} \sPacketD{}}
  \s\MYitems	{}
}
 
\NEW{Place}{\pEntryWay}{
  \s\MYname	{Stairwell}
	\s\MYsigns	{\sOldMan{} \sOldManStory{} \sDotTwo{}}
  \s\MYitems	{}
}
  
\NEW{Place}{\pBanquet}{
  \s\MYname	{-013}
	\s\MYsigns	{\sBanquetHall{} \sBanquetHall{} \sStage{}}
  \s\MYitems	{}
}
...
\NEW{Place}{\pCaves}{
  \s\MYname	{-015}
	\s\MYsigns	{\sCaves{} \sClamBed{} \sPearlStorage{} \sCrest{} \sRunicCircle{} \sPacketB{}}
  \s\MYitems	{\multi{2}{\iSnails{}} \multi{6}{\iSeaUrchins{}}}
} 
  
\NEW{Place}{\pResidentialWing}{
  \s\MYname	{-030}
	\s\MYsigns	{\sResidences{} \sResidences{} \sKing{} \sKingPapers{} \sGeneral{} \sGeneralPapers{} \sMorvyn{} \sMorvynPapers{} \sPriest{} \sPriestPapers{} \sPrincess{} \sPrincessPapers{} \sAriel{} \sArielPapers{} \sManta{} \sMantaPaper{} \sPlant{} \sPlantPapers{} \sPacketC{}}
  \s\MYitems	{}
}
...
\NEW{Place}{\pPacificanSuite}{ %%Big room farthest away.  Actually pacifican embassy.
  \s\MYname	{Room -004}
  \s\MYsigns	{\sEmbassy{} \sEmbassy{} \sDiplomat{} \sDiplomatPapers{} \sPrince{} \sPrincePapers{} \sSpy{} \sSpyPapers{} \sPacketA{} \sDesk{}}
  \s\MYitems  {}
}

\NEW{Place}{\pKitchen}{
  \s\MYname	{across from -004}
	\s\MYsigns	{\sKitchen{} \sSeaSnake{} \sSwordfishMeat{}\sDotThree{}}
  \s\MYitems	{}
}
...
\NEW{Place}{\pGM}{
  ...
  \s\MYgreens{}
  \s\MYitems  {\iScroll{} \iCipherLetter{}}
  \s\MYsigns  {}
  }
