...
\NEW{Place}{\pLibrary}{ %%Royal archives; Treasury  = Museum
   \s\MYname	{Room -002}
   \s\MYsigns	{\sMuseum{} \sMuseum{} \sMuseumItems{} \sArifactOne{} \sArtifactTwo{} \sArtifactTwoBroken{}}
...
\NEW{Place}{\pExplorerGuild}{
  \s\MYname	{Hallway near -015}
	\s\MYsigns	{\sExplorersDoor{} \sExplorersInventory{}}
  \s\MYitems	{}
}

\NEW{Place}{\pCaves}{
  \s\MYname	{-015}
	\s\MYsigns	{\sCaves{} \sClamBed{} \sPearlStorage{}}
