...
\NEW{Item}{\iWishingStone}{
  ...
  \s\MYtext	{An ordinary looking stone that feels exceptionally cool to the touch. {\bf This item must be transfered willingly. If the item is taken by force or from an unconscious holder, the stone immediately loses its ability.} Refer to the associated ability to learn what the stone can do.}
  \unstash{}
}
