...
\NEW{ItemFold}{\iBaby}{
  \s\MYname	{A Baby}
  \s\MYnumber	{268}
  \s\MYtext	{A baby mer. Why would this be in the palace? If you are in possession of this baby, you must roleplay feeding it in the kitchens every half an hour. If you fail to feed the baby, run while carrying it, or engage in combat, give this item to an NPC and tell them to open it. You may voluntarily give the baby to an NPC to take to the palace nursery after 1 hr of care.}
  \s\MYcontents	{This mer baby has not been well taken care of. Roleplay a nurse from the palace nursery who is very upset by this. You should berate the player soundly for being neglectful, preferably in front of as many others as possible, and then take the baby out of game.}
  \bulky{1}
  \unstash{}
}
...
\NEW{ItemFold}{\iPacificanLaw}{
  \s\MYname	{An old book of \pPacifica{}n Law}
  \s\MYnumber	{909}
  \s\MYtext	{This book appears to contain old \pPacifica{}n laws that most have forgotten. Spend 1 minute reading it to open.}
  \s\MYcontents	{Apparently, the \iGlowShell{} was once thought to be a powerful artifact sent from the Kraken, and presenting one to a \pPacifica{}n }
}
...
\NEW{ItemEnvelope}{\iPoison}{
  ...
  \s\MYnumber	{221}
  \s\MYtext	{Open if you drink}
  \s\MYcontents	{You have been poisoned! You are slightly nauseous, now mute, and will die in 10 minutes if you do not receive first aid {\bf AND} consume a healing potion. As soon as you do both of these things, you are cured-- you won't die and are no longer mute.}
}
