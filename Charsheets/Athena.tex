...
\updatemacro{\cGeneral}{
  \nickname{Isaac Carlson}
  \mapnickinformal
}
...
Your name is \cQueen{}. Well, actually it is \cAthena{}, but everyone who knew you by that name thinks you are dead.
...
\begin{itemz}[Goals]
  ...
  \item Pass the secret of the \iMusicBox{} on to \cAriel{} or \cPrincess{}.
  \item Foil the assassination attempt against \cKing{}.
  \item Avoid being discovered as \cAthena{\King} \cQueen{}.
\end{itemz}
