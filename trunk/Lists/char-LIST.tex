...
\NEW{PC}{\cSlave}{ %% Eric and Ariel know him by the name Aldric (he is in disguise right now)
   ...
   \s\MYsex      {\male}
   \s\MYnumber	{649}
   \s\MYdesc     {An elderly merman with far off eyes}   
...
\NEW{PC}{\cAriel}{
   ...
   \s\MYsex      {\female}
   \s\MYnumber	{386}
   \s\MYdesc     {An attractive human woman with flaming red hair and an innocent air}   
...
\NEW{PC}{\cWillow}{
   ...
   \s\MYsex      {\male}
   \s\MYnumber	{143}
   \s\MYdesc     {An 16 year old human kid with curly red hair}
...
\NEW{PC}{\cBodyguard}{
   ...
   \s\MYsex      {\female}
   \s\MYnumber	{397}
   \s\MYdesc     {An imposing merwoman with eyes constantly scanning for threats}   
...
\NEW{PC}{\cSpy}{
   ...
   \s\MYsex      {\male}
   \s\MYnumber	{347}
   \s\MYdesc     {A merman with a slightly distracted look}   
	 \s\MYplayer	{David Lo}
