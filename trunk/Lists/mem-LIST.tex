...
\NEW{MemPage}{\mPlantB}{
  ...
  \s\MYtext	{This is the \cKing{\King}'s \cKing{\sibling}. \cPlant{\They} is paranoid but harmless. \cPlant{\They} is not your suspect.}
}
...
\NEW{MemPage}{\mQueenB}{
  ...
  \s\MYtext	{\cQueen{}'s history as \cQueen{} drops off 21 years ago. This is unsurprising as this is when \cQueen{they} fled the capital. On the other hand, \cAthena{} has no history beyond 34 years ago, despite being considerably older than that\ldots{} \cQueen{\They} is not your suspect.}
  }
...
\NEW{MemPage}{\mArielB}{
  ...
  \s\MYtext	{\cAriel{} is now \cAriel{\King} of \pEuropa{}. \cAriel{\They} can't be involved with the mafia and is not your suspect.}
}

\NEW{MemPage}{\mWillowB}{
  \s\MYname	{Open if you do a background check on badge 143.}
  \s\MYtext	{A child? Really? Not your suspect.}
}

\NEW{MemPage}{\mMantaB}{
  \s\MYname	{Open if you do a background check on badge 615.}
  \s\MYtext	{\cManta{} has a very interesting history, with many\ldots{} suspicious\ldots{} gaps. Whatever \cManta{\they} is up to, you might want to keep an eye on \cManta{them}. \cManta{\They} is not your suspect though.}
}

\NEW{MemPage}{\mDiplomatB}{
  \s\MYname	{Open if you do a background check on badge 276.}
  \s\MYtext	{As a \pPacifica{}n, your information on \cDiplomat{} is limited, but \cDiplomat{\they} seems to appear out of nowhere about 3 years ago. \cDiplomat{\They} is not your suspect though.}
}

\NEW{MemPage}{\mBodyguardB}{
  \s\MYname	{Open if you do a background check on badge 397.}
  \s\MYtext	{As a \pPacifica{}n, your information on \cDiplomat{} is limited, but \cBodyguard{} appears to be \cPrince{}'s personal guard. Records do indicate that \cBodyguard{} wants a child very badly, but \cBodyguard{\they} is not your suspect.}
}

\NEW{MemPage}{\mPrinceB}{
  \s\MYname	{Open if you do a background check on badge 271.}
  \s\MYtext	{As a \pPacifica{}n, your information on \cPrince{} is limited, but \cPrince{} is the \cPrince{\Prince} of \pPacifica{}. \cPrince{\They} is not your suspect.}
}

\NEW{MemPage}{\mSpyB}{
  \s\MYname	{Open if you do a background check on badge 347.}
  \s\MYtext	{As a \pPacifica{}n, your information on \cSpy{} is limited, but \cSpy{they} appears to have no record beyond 17 years ago. \cSpy{\They} is not your suspect though.}
}
