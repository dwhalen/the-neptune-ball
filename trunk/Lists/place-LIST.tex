...
\NEW{Place}{\pBanquet}{
  \s\MYname	{-013}
	\s\MYsigns	{\sBanquetHall{} \sBanquetHall{} \sStage{} \sGlowingBrick{}}
  \s\MYitems	{}
}
...
\NEW{Place}{\pGarden}{ %%Garden for items/negotiate
  \s\MYname	{-032}
	\s\MYsigns	{\sGardens{} \sSeaFans{} \sGlowingBrick{}}
