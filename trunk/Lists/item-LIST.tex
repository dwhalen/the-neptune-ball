...
\NEW{ItemEnvelope}{\iPoison}{
  ...
  \s\MYnumber	{221}
  \s\MYtext	{open if you drink}
  \s\MYcontents	{You have been poisoned! You are slightly nauseous, now mute, and will die in 10 minutes if you do not receive {\bf first aid AND consume a healing potion}. As soon as you do both of these things, you are cured-- you won't die and are no longer mute.}
}
