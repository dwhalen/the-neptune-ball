...
\NEW{Item}{\iSignetRing}{
  \s\MYname	{A \pPacifica{}n Signet Ring}
  \s\MYnumber	{999}
...
\NEW{ItemFold}{\iShapeshifterPotion}{
  \s\MYname	{A Gold Potion}
  \s\MYnumber	{999}
  \s\MYtext	{Open if you consume}
  \s\MYcontents	{You have been transformed into a Shapeshifter! Go retrieve the \aRevealed{} ability card, the \iShapeshifterSpell{} magical effect, and a green headband from \sRevealed{} in the \pBanquet{}. Do not put on the headband until told to do so.}
}
...
\NEW{Item}{\iShapeshifterSpell}{
  \s\MYname	{Shapeshifted}
  \s\MYnumber {999}
  \s\MYtext	{Level 6. This spell effect is what has turned you into a shapeshifter. If this magical effect is removed by any means, reverse all effects of being turned into a shapeshifter.).}
  \effect{}
}
