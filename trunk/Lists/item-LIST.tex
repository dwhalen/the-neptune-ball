...
\NEW{Item}{\iSnails}{
  ...
  \s\MYnumber	{999}
  \s\MYtext	{All Conus snails are venomous and capable of ``stinging'' merfolk. Live ones should be handled with great care or preferably not at all. If you handle this item, you are paralyzed for 1 minute (you cannot talk, move or attack. You {\bf can} resist if you have the CR). This effect can happen to you once every 5 minutes.}
}
