...
\NEW{Item}{\iBaby}{
  \s\MYname	{A Baby}
  \s\MYnumber	{999}
  \s\MYtext	{A baby mer. Why would this be in the palace?}
}
...
\NEW{ItemEnvelope}{\iArielAmulet}{
  \s\MYname	{an amulet carved from shell}
  \s\MYnumber	{999}
    \s\MYtext	{The eyes of the carved face glow with an other-worldly light. Open if you make a wish.}
  \s\MYcontents	{The water grows murky and cold around you. Dark voices whisper terrible things in your ears. Go ``Not Here'' and read your new greensheets.}
  \s\MYgreens{}
}
...
\NEW{Item}{\iRapSheet}{
  \s\MYname	{Rap Sheet}
  \s\MYnumber	{999}
  \s\MYtext	{This rap sheet is for \cLiar{}. It is long and detailed. \cLiar{\They} is clearly a master con artist.}
}
...
\NEW{Item}{\iNorthSeasJournal}{
  ...
  \s\MYnumber	{999}
  \s\MYtext	{This is a detailed journal of an Explorer's Guild member's investigation of North Sea Shipwrecks. It documents a particular wreck that sunk on \cKracken{\MYname}, as having been beset upon by the Kraken, in the throws of a storm. It goes on to marvel for pages at the great strength of the Kraken.}
}
...
\NEW{ItemEnvelope}{\iPoison}{
  ...
  \s\MYnumber	{999}
  \s\MYtext	{open if you drink}
  \s\MYcontents	{You have been poisoned! You are slightly nauseous, now mute, and will die in 10 minutes if you do not receive {\bf medical attention AND consume a healing potion}. As soon as you do both of these things, you are cured-- you won't die and are no longer mute.}
}
...
\NEW{ItemEnvelope}{\iTransformationPotion}{
  ...
  \s\MYnumber	{999}
  \s\MYtext	{open if you drink}
  \s\MYcontents	{You have been transformed from a mer-person to a human or vice versa. If necessary, acquire a green headband from \pBanquet{}. Your CR is {\bf reduced by one} (your CR cannot go below zero).}
...
\NEW{ItemEnvelope}{\iShapeshifterPotion}{
  ...
  \s\MYnumber	{999}
  \s\MYtext	{open if you drink}
  \s\MYcontents	{You have been transformed into a Shapeshifter! Retrieve a green headband from \sRevealed{} in the \pBanquet{}. Do not put on the headband until told to do so.}
  \s\MYabils {\aRevealed{}}
...
\NEW{ItemEnvelope}{\iLovePotion}{
  ...
  \s\MYnumber	{999}
  \s\MYtext	{open if you drink}
  \s\MYcontents	{You are madly in love with \cWitch{} and are compelled to obey \cWitch{\their} every command. You only want to make them happy. You can't stand the thought of \cWitch{\their} being mad at you. You gain the goal: ``Find some way to remain with \cWitch{} once the ball concludes.''}
...
\NEW{Item}{\iEnslavementSpell}{
  ...
  \s\MYnumber {999}
  \s\MYtext	{Level 4. This spell prevents you from going against the will of your master. You may not act in any way that would directly harm your master, including speaking ill of them. You also may not act in any way that would work towards revealing that you are ensorcelled (you must attempt to resist magical searches from anyone other than your master).}
  \effect{}
}
...
\NEW{Item}{\iLoveSpell}{
  ...
  \s\MYnumber {999}
  \s\MYtext	{Level 4. This spell prevents you from going against the will of your lover. You may not act in any way that would directly harm your lover, including speaking ill of them. You also may not act in any way that would work towards revealing that you are ensorcelled (you must attempt to resist magical searches from anyone other than your lover). {\bf The effect of this spell is not unpleasant and you have no desire to break it.}}
  \effect{}
}
...
\NEW{Item}{\iIdentityProtectionSpell}{
  ...
  \s\MYnumber {999}
  \s\MYtext	{Level 4. This spell prevents you from revealing the identity of your master. You may not act in any way that would work towards revealing their identity, including speaking ill of them. This includes identifying them by omission, radically changing the way you react to them, or other roleplaying tricks (you are bound by the spirit of this powerful effect).}
  \effect{}
}
