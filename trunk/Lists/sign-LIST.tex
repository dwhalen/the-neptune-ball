...
% The guest rooms
\NEW{Sign}{\sGuestRooms}{
  \s\MYname	{Bedrooms}
  \s\MYloc	{}
  \s\MYtext	{There are three ways to gain entrance to this bedroom:
...
\NEW{Sign}{\sArtifactZero}{
  ...
  \s\MYloc	{- 002}
  \s\MYtext	{There is an empty pedestal here. There is no plaque. It is anyone's guess what it used to hold.}
  \s\MYitems {}
}
