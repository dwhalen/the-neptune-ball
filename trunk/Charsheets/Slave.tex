...
\begin{itemz}[Goals]
	...
	\item Acquire the wishing stone - that could be an easy shortcut to removing the spell, or a powerful bargaining chip otherwise.
...
\begin{itemz}[Notes]
  \item You have long been working away at the spell that \cWitch{} uses to control you. No single standing order issued during the ball can compel you beyond 5 minutes. It may be useful to pretend otherwise, however.
\end{itemz}
