...
\begin{enumerate}
  ...
  \item Level 3
     \begin{enumerate}
     \item Latent Poison (GREEN) - 30 minutes to brew. This poison can be cured with a healing potion or \aFirstAid{}. It will take between 20 and 30 minutes to affect the target. Ingredients Required: 1 common, 1 explorer's guild.
   \end{enumerate}
   \item Level 4 - No useful spells or potions
   \item Level 5
    \begin{enumerate}
     \item Transformation Potion (ORANGE) - 20 minutes to brew. This potion will transform a merperson into a human or vice versa. This transformation reduces your CR by one (your CR cannot go below zero). Ingredients Required: 1 rare, 2 explorer's guild.
   \end{enumerate}
   \item Level 6
    \begin{enumerate}
